...
var fileList = [
  ...
  {"url":"/script.js","file":"./js/script.js" , "code": "utf-8", "type": "{'Content-Type': 'application/javascript'}"},
  {"url":"/idle_princess2.gif","file":"./resources/idle_princess2.gif" , "code": "", "type": "{'Content-Type': 'image/gif'}"},
  {"url":"/favicon.ico","file":"./resources/favicon.ico" , "code": "", "type":"{'Content-Type': 'image/ico'}"},
  {"url":"/jquery-3.3.1.min.js","file":"./js/jquery-3.3.1.min.js" , "code": "utf-8", "type": "{'Content-Type': 'application/javascript'}"},
  {"url":"/modernizr.custom.js","file":"./js/modernizr.custom.js" , "code": "utf-8", "type": "{'Content-Type': 'application/javascript'}"},
  {"url":"/demo1.js","file":"./js/demo1.js" , "code": "utf-8", "type":"{'Content-Type': 'application/javascript'}"},
  {"url":"/classie.js","file":"./js/classie.js" , "code": "utf-8", "type":"{'Content-Type': 'application/javascript'}"},
  ...
  {"url":"/BLKCHCRY.TTF","file":"./ttf/BLKCHCRY.TTF" , "code": "", "type": "{'Content-Type': 'application/octet-stream'}"}
];
