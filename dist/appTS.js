...
var Gpio_D = require('pigpio').Gpio, trigger = new Gpio_D(23, { mode: Gpio_D.OUTPUT }), echo = new Gpio_D(24, {
    mode: Gpio_D.INPUT,
    alert: true
}); // Paramettrage
...
function impressionNow() {
    ...
    io.emit('message', 1);
    const text = 'lp -d Canon_SELPHY_CP1200 -o landscape -o fit-to-page .' + global.lienImage;
    //var text = "ls";
    exec(text, (e, stdout, stderr) => {
        logger.fatal(e);
    });
